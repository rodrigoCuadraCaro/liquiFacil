                                ...
                                <li>
                                    <a href="#" target="_blank"
                                       className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                        ...
                                        <span className="ml-3 flex-1 whitespace-nowrap">Correo</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#"
                                ...
                                <li>
                                    <a href="#"
                                       className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                        ...
                                        <span className="ml-3 flex-1 whitespace-nowrap">hola</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#"
